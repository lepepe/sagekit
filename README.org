...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="./docs/style.css">
#+OPTIONS: num:nil
...
client.account_sets.retreive('COMPANY', 'NUMBER')
client.account_sets.create('COMPANY', {})
client.account_sets.update('COMPANY', {})
client.account_sets.delete('COMPANY', 'NUMBER')
#+end_src
...
client.sales_orders.retreive('COMPANY', 'ID')
...
client.invoices.retreive('COMPANY', 'ID')
#+end_src
...
client.credit_notes.retreive('COMPANY', 'ID')
...
client.purchase_orders.retreive('COMPANY', 'ID')
...
client.receipts.retreive('COMPANY', 'ID')
...
client.vendor_contract_costs.retreive('COMPANY', 'ITEM_NUMBER', 'VENDOR_NUMBER')
client.vendor_contract_costs.create('COMPANY', {})
client.vendor_contract_costs.update('COMPANY', 'ITEM_NUMBER', 'VENDOR_NUMBER', {})
client.vendor_contract_costs.delete('COMPANY', 'ITEM_NUMBER', 'VENDOR_NUMBER')
#+end_src
